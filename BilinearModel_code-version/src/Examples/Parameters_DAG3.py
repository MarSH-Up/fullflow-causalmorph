...
A = np.array(
    [
        [0, 0, 0],  # Region 1 (no incoming connections)
        [-0.49, 0, 0],  # Region 2 (connected from Region 1)
...
B2 = np.array([[0, 0, 0], [0.77, 0, 0.77], [0.77, 0, 0]])
...
C = np.array([[0.08, 0, 0], [0.08, 0, 0], [0.08, 0, 0]])
